...
export default function Contact() {
  ...
  const contactInfo = [
    { icon: <Mail />, label: 'Email', value: 'contact@d40network.org' },
    { icon: <Phone />, label: 'Phone', value: '+90 (212) 555 0100' },
    { icon: <MapPin />, label: 'Offices', value: 'Istanbul / Brussels' },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <div className="p-8 rounded-3xl bg-brand-light border border-brand-blue/5">
              <h3 className="text-xl font-bold mb-6">Inquiry Types</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center space-x-3 p-4 bg-white rounded-xl">
                  <Building2 size={20} className="text-brand-orange" />
                  <span className="text-sm font-bold">Join Network</span>
                </div>
                <div className="flex items-center space-x-3 p-4 bg-white rounded-xl">
                  <Users size={20} className="text-brand-orange" />
                  <span className="text-sm font-bold">Partner Request</span>
                </div>
                <div className="flex items-center space-x-3 p-4 bg-white rounded-xl">
                  <Zap size={20} className="text-brand-orange" />
                  <span className="text-sm font-bold">Project Collab</span>
                </div>
                <div className="flex items-center space-x-3 p-4 bg-white rounded-xl">
                  <MessageSquare size={20} className="text-brand-orange" />
                  <span className="text-sm font-bold">Media Inquiry</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea rows={5} className="w-full px-4 py-3 rounded-lg bg-brand-light border-none focus:ring-2 focus:ring-brand-orange" placeholder="How can we help you?"></textarea>
              </div>
